...
document.getElementById("char-gen-button").addEventListener("click", () => {
    ...
    document.getElementById("char-res").innerHTML = table([
        ...
        ["skin", pick_color(1, 4, 5.0)],
        ["extra", pick(extra, 1, 4, 3.0)],
        hr,
        ["hair", pick(hair_length) + pick(hair_texture) + pick_color(1, 3, 3.0)],
        ["eye color", pick_color(1, 2, 5.0)],
        ["ears", pick(ears)],
        hr,
        ["top", pick(clothing_textures) + pick(tops) + pick_color(1, 3, 8.0)],
        ["bottom", pick(clothing_textures) + pick(bottoms) + pick_color(1, 3, 8.0)],
        ["shoes", pick(shoes) + pick_color(1, 3, 9.0)],
        hr,
